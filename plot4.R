plot4 <- function() {
	...
	par(mfcol=c(2,2))
	with(filter_data, plot(datetime, Global_active_power, xlab="", ylab="Global Active Power", type="l"))
	...
	with(filter_data, plot(datetime, Global_reactive_power, ylab="Global_reactive_power", type="l"))
